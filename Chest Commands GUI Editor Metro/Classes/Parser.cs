namespace CCGE_Metro.Classes {
    ...
    internal static class Parser {
        /// <summary>
        /// Convert the string representation of information of a <see cref="Types.MinecraftItem"/> to a <see cref="Types.MinecraftItem"/> object in a <see cref="System.Windows.Forms.ComboBox"/>.
        /// </summary>
        ...
        public static void ComboBox_ParseInput(System.Windows.Forms.ComboBox cbox) {
            ...
            try { cbox.Text = Types.MinecraftItem.Parse(cbox.Text).Name; }
